// package navmesh provides Go bindings for Recast Navigation library,
// enabling pathfinding and navigation mesh operations in Go applications.
package navmesh
...
var (
	...
	ErrFailedToFindPath    = &Error{"failed to find straight path"}
)
